    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $.each(data.views, function(index, val) {
                $(".fh5co-gallery").append("<a class=\"gallery-item\" href=\"<?= Yii::$app->params['hostUrl']?>"+val.id+".html\"><img src=\"<?= Yii::$app->params['qnUrl']?>"+val.scan_img+"\" alt=\"\"><span class=\"overlay\"><h2>"+val.name+"</h2></span></a>");
            });
